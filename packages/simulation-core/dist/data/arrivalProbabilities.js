...
exports.getArrivalProbabilityForTick = exports.parsedArrivalProbabilities = exports.rawArrivalProbabilities = void 0;
/**
 * T1: Arrival probabilities
 * Probability of an EV arriving at a chargepoint at a given time.
 * Data directly from the PDF.
 */
exports.rawArrivalProbabilities = {
    '00:00 - 01:00': 0.0094,
    '01:00 - 02:00': 0.0094,
    '02:00 - 03:00': 0.0094,
    '03:00 - 04:00': 0.0094,
 ...
 */
exports.parsedArrivalProbabilities = Object.entries(exports.rawArrivalProbabilities).map(([timeRange, probability]) => {
 ...
 */
const getArrivalProbabilityForTick = (tick) => {
    ...
    const hourlyMatch = exports.parsedArrivalProbabilities.find(p => p.hour === hourOfDay);
...
exports.getArrivalProbabilityForTick = getArrivalProbabilityForTick;
